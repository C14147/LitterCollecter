...
model.optimizer.learning_rate.assign(initial_lr * 1.2)


def lr_scheduler(epoch):
    lr = float(model.optimizer.learning_rate)
    if epoch == 2:
        model.optimizer.learning_rate.assign(lr / 1.2)
...
log_dir = f"logs/v1/{model_version}"
...
model.save("LitterCollecter2_{}.keras".format(model_version))
